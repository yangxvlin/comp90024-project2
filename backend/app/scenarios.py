...
class Scenario1(Resource):
    ...
    def get(self):
        """
        curl -d "lga=vic,20110&weekday=1,2,3&daytime_start=0&daytime_end=24&age_group=0,1,2,17" -u group3:b1ae877ce7cd4e8a5fbd1615b1bd1780057c0774d0cb26adafadabde66e33fb0 -X GET http://127.0.0.1:5000/scenario1
        :return:
        """
        ...
        print(selected_age_groups_attribute)
        weekday = args['weekday'].split(',')
        daytime_start_hour = args['daytime_start']
        daytime_end_hour = args['daytime_end']

        population_data = read_aurin_result_data("/population-age-data/result-population.json")
        population_data_meta = read_aurin_result_data("/population-age-data/result-meta.json")
        ...
        for key, value in population_data.items():
            if key in selected_lga_list:
                ...
                result["selected_lga"][key]["lga_name"] = value["lga_name"]
    ...
    def post(self):
        """
        curl -d "lga=vic,20110&weekday=1,2,3&daytime_start=0&daytime_end=24&age_group=0,1,2,17" -u group3:b1ae877ce7cd4e8a5fbd1615b1bd1780057c0774d0cb26adafadabde66e33fb0 -X POST http://127.0.0.1:5000/scenario1
        :return:
        """
        parser = reqparse.RequestParser()
        parser.add_argument('lga', required=True, action='split', help='missing or ' + LGA_LIST_ERROR_MSG)
